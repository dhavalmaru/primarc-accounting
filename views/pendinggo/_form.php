...
<div class="grn-form">
  <div class=" col-md-12">  
        <form id="form_sale_details" action="<?php echo Url::base(); ?>index.php?r=pendinggo%2Fsave" method="post" onkeypress="return event.keyCode != 13;">
        ...
        <div class="row row-container">
            <div class="form-group">
    			...
    			<div class="col-md-2 col-sm-2 col-xs-6">
                    ...
                    <div class=" ">
                        <input type="hidden" class="form-control" name="gi_go_id" id="grn_id" placeholder="Go No" value="<?= $grn_details[0]['gi_go_id'] ?>" />
                ...
                <div class="col-md-2 col-sm-2 col-xs-6">
                    ...
                    <div class="">
                        <input type="text" class="form-control" id="gi_go_ref_no" placeholder="DC No" value="<?= $grn_details[0]['dcno'] ?>" readonly />
                    </div>
                </div>
                 <div class="col-md-2 col-sm-2 col-xs-6">
                    <label class="control-label">B2B/B2C</label> 
                    <div class=" ">
                        <input type="hidden" class="form-control" name="" id="gi_go_id" placeholder="B2B" value="B2B" />
                         <input type="text" class="form-control" id="gi_go_ref_no" placeholder="B2B" value="B2B" readonly />
                    </div>
                </div>
		        <div class="col-md-2 col-sm-2 col-xs-6">
                    ...
                    <div class=" "> 
                        ...
                        <!-- <input type="hidden" class="form-control" name="vendor_code" id="vendor_code" value="" /> --> 
                        <input type="text" class="form-control" name="vendor_name" id="vendor_name" value="<?= $grn_details[0]['customerName'] ?>" readonly />  
                    </div>
                </div>
    		    <div class="col-md-2 col-sm-2 col-xs-6">
    			...
    			<div class="col-md-2 col-sm-2 col-xs-6">
                  ...
                  <div class=" "> 
    				 <input type="text" class="form-control" name="location" id="location"   value="<?= $grn_details[0]['warehouse_state'] ?>" readonly />  
                  </div>
    			</div>
                <div class="col-md-2 col-sm-2 col-xs-6">
                    <label class=" control-label">Location To </label> 
                  <div class=" "> 
                     <input type="text" class="form-control" name="location" id="location"   value="<?= $grn_details[0]['customerState'] ?>" readonly />  
                  </div>
                </div>
    			<div class="col-md-2 col-sm-2 col-xs-6">
            ...
            <table id="update_grn" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="sticky-cell" style="border: none!important;">
                        ...
                        <input type="hidden" id="sub_particular_cost_<?php echo $j;?>" name="sub_particular_cost[]" value="<?php echo 'Sales_'.$total_tax[$j]['tax_zone_code'].'_'.$total_tax[$j]['vat_cst'].'_'.$total_tax[$j]['vat_percent']; ?>" />
                        ...
                        <select id="totalamount_acc_id_0" class="form-control acc_id" name="total_amount_acc_id" onChange="get_acc_details(this)" style="display: none;">
                            ...
                            <?php for($i=0; $i<count($acc_master); $i++) { 
                                    if($acc['total_amount_acc_id']==""){
                                        if($grn_details[0]['vendor_id1']==$acc_master[$i]['customer_id']) {
        ...
        <div class="form-group btn-margin">
            ...
            <a class="btn btn-sm btn-danger pull-right" href="<?php echo Url::base(); ?>index.php?r=pendinggo%2Findex">Close</a>
        ...
        <table id="debit_note" class="table table-bordered">
            ...
            <tr>
                <td><?php echo $i+1; ?></td>
                <td><?php echo $debit_note[$i]['invoice_number']; ?></td>
                ...
                <td><a href="<?php echo Url::base(); ?>index.php?r=pendinggo%2Fviewdebitnote&invoice_id=<?php echo $debit_note[$i]['gi_go_invoice_id']; ?>" target="_blank">View</a></td>
                <td><a href="<?php echo Url::base(); ?>index.php?r=pendinggo%2Fdownload&invoice_id=<?php echo $debit_note[$i]['gi_go_invoice_id']; ?>" target="_blank">Download</a></td>
                <td><a href="<?php echo Url::base(); ?>index.php?r=pendinggo%2Femaildebitnote&invoice_id=<?php echo $debit_note[$i]['gi_go_invoice_id']; ?>">Email</a></td>
            </tr>
            <?php } ?>
        </table>
        </div>
