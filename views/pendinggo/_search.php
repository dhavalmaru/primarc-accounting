...
<div class="grn-search">
    ...
    <?= $form->field($model, 'scanned_qty') ?>

    <?= $form->field($model, 'payable_val_after_tax') ?>
    ...
    <?php // echo $form->field($model, 'gi_id') ?>

    <?php // echo $form->field($model, 'gi_date') ?>

    <?php // echo $form->field($model, 'vat_cst') ?>

    <?php // echo $form->field($model, 'grn_start_date_time') ?>
