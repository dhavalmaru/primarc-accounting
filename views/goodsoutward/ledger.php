...
<div class="grn-view">  
    <div class=" col-md-12"> 
        ...
        <h5 class="text-center">Go Posting Voucher</h5>
        <?php 
            ...
            echo "</pre>";*/
        ?>
        <div>Vendor/Washouse Name: <?php echo ($grn_details[0]['vendor_name']!=""?$grn_details[0]['vendor_name']:$grn_details[0]['idt_warehouse']) ?></div>
        ...
        for($i=0; $i<count($acc_ledger_entries); $i++) {
            ...
            if($blFlag == true){
                ...
                if(isset($acc_ledger_entries[0]["invoice_created_date"])) {
                    if(($acc_ledger_entries[0]["invoice_created_date"]!=null && $acc_ledger_entries[0]["invoice_created_date"]!='' && $acc_ledger_entries[0]["invoice_created_date"]!="0000-00-00 00:00:00")){
                        $invoice_created_date = date('d/m/Y',strtotime($acc_ledger_entries[0]["invoice_created_date"]));
                    }
                }
                ...
                $table = '<div class="diversion">
                            ...
                            <div class="pull-right">Invoice Date: ' . $invoice_created_date . '</div>
