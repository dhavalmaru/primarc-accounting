...
$this->title = 'Update Goods Outward: ' . '';//$grn_details[0]['grn_id'];
$this->params['breadcrumbs'][] = ['label' => 'Goods Outward', 'url' => ['index']];
...
<div class="grn-update"> 
    ...
    <?= $this->render('_form', ['grn_details' => $grn_details, 'total_val' => $total_val, 'total_tax' => $total_tax, 
                                ...
                                'debit_note' => $debit_note, 'action' => $action,'ware_array'=>$ware_array,'skuwise' => $skuwise,'tax_per'=>$tax_per]) ?>
