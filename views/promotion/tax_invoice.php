    ...
    <table width="100%" border="0" cellspacing="0" class="table" style="border-collapse:collapse;  ">
        ...
        <tr>
            ...
            <td width="14%" style="border:none;">
              ...
              <td colspan="2" align="center" valign="top" style="border-right:none;"><p><b>Dispatch Document No. </b>
			<br> </p></td>
			<td colspan="1" align="center" valign="top" style="border-right:none;"><p><b>Delivery Note Date</b>
			<br> </p></td>
        </tr>
        <tr>
		 ...
		 <tr>
            <td colspan="6"  style="border-left:none;border-right:none;border-bottom:none;"></td>
                   ...
                   <table class="table table-bordered">
						...
						<tr>
						<td colspan="6" style=" border-top:1px solid #999;border-bottom:1px solid #999; "> <span style="  font-size:16px; font-weight:500; display: block;" > 
                            Amount Chargeable (in words): <br/><br/> 
                        </span> <?php if(isset($invoice_details[$i]['amount'])) echo $mycomponent->convert_number_to_words(round($invoice_details[$i]['amount'],2)); ?>   </td>
                    ...
                    <table style="width: 100%;border-spacing: 0;height: 36px;"><tr><td colspan="2" style="text-align: center;border:none;">IGST</td></tr><tr><td style="border-right:1px solid #666;border-bottom:0px solid #666;border-top: 1px solid #666;text-align: center;border-left:0px solid #666;" width="50%">Rate</td><td style="border-right:0px solid #666;border-bottom:0px solid #666;border-top: 1px solid #666;border-left:0px solid #666;text-align: center;" width="50%">Amount</td></tr></table>
							...
							<?php for($i=0; $i<count($inv_tax_details)-1; $i++){ ?>
							   <tr>
                                    ...
                                    <td><?php echo $inv_tax_details[$i]['value']; ?></td>
                                    ...
                                    <td>  <?php echo $inv_tax_details[$i]['value'] + $inv_tax_details[$i]['cgst_amt'] + 
                                    $inv_tax_details[$i]['sgst_amt'] + $inv_tax_details[$i]['igst_amt']; ?> </td>
										...
										<table style="width: 100%;border-spacing: 0; height: 17px;">
											<tbody>
												<tr>
													...
													<td style="border-right:0px solid #666;border-left:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%"><?php echo $inv_tax_details[$i]['cgst_amt']; ?></td>
												</tr>
											</tbody>
										</table>
									</td>
									<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:1px solid #666;padding:0;">
										<table style="width: 100%;border-spacing: 0; height: 17px;">
											<tbody>
												<tr>
													<td style="border-right:1px solid #666;border-bottom:0px solid #666;border-left:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%"></td>
													<td style="border-right:0px solid #666;border-left:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%"><?php echo $inv_tax_details[$i]['sgst_amt']; ?></td>
												</tr>
											</tbody>
										</table>
									</td>
									<td align="center" valign="middle" style="border-right:1px solid #666;border-bottom:1px solid #666;padding:0;">
										<table style="width: 100%;border-spacing: 0; height: 17px;">
											<tbody>
												<tr>
													<td style="border-right:1px solid #666;border-bottom:0px solid #666;border-left:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%"></td>
													<td style="border-right:0px solid #666;border-left:0px solid #666;border-bottom:0px solid #666;border-top: 0px solid #666;text-align: right;" width="50%"><?php echo $inv_tax_details[$i]['igst_amt']; ?></td>
												</tr>
											</tbody>
										</table>
									</td>
									<td valign="top" align="right" style="border-left:1px solid #666;border-right:1px solid #666;border-bottom:1px solid #666;">
