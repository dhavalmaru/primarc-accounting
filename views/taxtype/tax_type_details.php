...
$this->title = ucfirst($action) . ' Tax Type Master' . (isset($data[0]['id'])?': '.$data[0]['id']:'');

$this->params['breadcrumbs'][] = ['label' => 'Tax Type Master', 'url' => ['index']];
...
<div class="grn-index">
	<div class=" col-md-12 ">
		<form id="tax_type" class="form-horizontal" action="<?php echo Url::base(); ?>index.php?r=taxtype%2Fsave" method="post" onkeypress="return event.keyCode != 13;"> 
			...
			<div class="form-group">
				<div class="col-md-3 col-sm-12 col-xs-12">
					...
					<div class="">
						...
						<input type="text" id="tax_name" class="form-control"  name="tax_name" value="<?php if(isset($data[0])) echo $data[0]['tax_name']; ?>" />
					</div>
				</div>
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
					...
					<div class="">
						<div class="">  
							<input id="tax_details" name="tax_details" class="form-control" type="text" value="<?php if(isset($data[0])) echo $data[0]['tax_details']; ?>"  />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="btn-container "> 
				<div class="col-md-12">
					...
					<a href="<?php echo Url::base(); ?>index.php?r=taxtype%2Findex" class="btn btn-primary btn-sm pull-right" >Cancel</a>
