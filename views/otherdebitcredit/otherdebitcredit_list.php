...
$this->title = 'Other Debit Credit List';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="grn-index">	
	<div class=" col-md-12 ">  
		<a href="<?php echo Url::base(); ?>index.php?r=otherdebitcredit%2Fcreate" style="<?php if(isset($access[0]['r_insert'])) { if($access[0]['r_insert']=='1') echo ''; else echo 'display: none;'; } else { echo 'display: none;'; } ?>"> 
			<button type="button" class="btn btn-grid btn-success btn-sm pull-right">Add New Debit Credit </button>
		</a>
								...
								<table id="example" class="table datatable table-bordered display" cellspacing="0" width="100%">
									...
									<tbody> 
										...
										<tr> 
											...
											<td>
												<a href="<?php echo Url::base() .'index.php?r=otherdebitcredit%2Fview&id='.$approved[$i]['id']; ?>" >View </a> <br/>
												<a href="<?php echo Url::base() .'index.php?r=otherdebitcredit%2Fedit&id='.$approved[$i]['id']; ?>" style="<?php if(isset($access[0]['r_edit'])) { if($access[0]['r_edit']=='1' && $access[0]['session_id']!=$approved[$i]['approver_id']) echo ''; else echo 'display: none;'; } else { echo 'display: none;'; } ?>">Edit </a> <br/>
												<!-- <a href="<?php //echo Url::base() .'index.php?r=otherdebitcredit%2Fauthorise&id='.$approved[$i]['id']; ?>" style="<?php //if(isset($access[0]['r_approval'])) { if($access[0]['r_approval']=='1' && $access[0]['session_id']==$approved[$i]['approver_id']) echo ''; else echo 'display: none;'; } else { echo 'display: none;'; } ?>">Authorise </a> -->
											</td> 
								...
								<table id="example1" class="table datatable table-bordered display" cellspacing="0" width="100%">
									...
									<tbody> 
										...
										<tr> 
											<td scope="row"><?php //echo $i+1; ?></td> 
											<td>
												<a href="<?php //echo Url::base() .'index.php?r=otherdebitcredit%2Fview&id='.$approved[$i]['id']; ?>" >View </a>
											</td> 
								...
								<table id="example2" class="table datatable table-bordered display" cellspacing="0" width="100%">
									...
									<tbody> 
										...
										<tr> 
											<td scope="row"><?php //echo $i+1; ?></td> 
											<td>
												<a href="<?php //echo Url::base() .'index.php?r=otherdebitcredit%2Fview&id='.$rejected[$i]['id']; ?>" >View </a> <br/>
												<a href="<?php //echo Url::base() .'index.php?r=otherdebitcredit%2Fedit&id='.$rejected[$i]['id']; ?>" style="<?php //if(isset($access[0]['r_edit'])) { if($access[0]['r_edit']=='1' && $access[0]['session_id']!=$rejected[$i]['approver_id']) echo ''; else echo 'display: none;'; } else { echo 'display: none;'; } ?>">Edit </a> <br/>
											</td> 
